...
{
    internal class InputEntity : IGameEntity, IInputHandlerManager
    {
        ...
        internal InputEntity(IKeyboardManager manager, IReadOnlyDictionary<Keys, CommandKeys> keyMap)
        {
            _manager = manager;
            _keyMap = keyMap;
        }

        public InputEntity(IReadOnlyDictionary<Keys, CommandKeys> keyMap) : this(new KeyboardManager(), keyMap) { }
